...
>(
  (
    { displayName, avatar, status, capabilities, thinkingSteps, ...props },
    ref,
  ) => {
    return (
...
ParticipantPrimitiveAgentProfile.displayName =
  "ParticipantPrimitive.AgentProfile";
